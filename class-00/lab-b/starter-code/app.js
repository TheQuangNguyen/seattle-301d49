...
//  this refers to the instance of Student constructor function, joe, as an object. 
// 2. What is "this" when joe.scopeArrow() is invoked?
//  this refers to the whole window object which contains a bunch of properties about the window that I am opening up
// 3. Explain why "this" is different when an arrow function is used.
//  When an arrow function is used for a constructor function or prototype that use 'this', the function scope bubbles up to the next-nearest scope. Because scopeArrow() was declared exclusively, 'this' is not referred to joe object but the global window object.
