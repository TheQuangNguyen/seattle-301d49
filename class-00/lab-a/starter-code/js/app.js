...
function displayPics() {
  ...
  // rando was declared earlier with var which is function-scoped and so any methods within the function displayPics can access the variable rando. When var changed to const, now the variable is scoped to only within the outer while loop and so when console.log is trying to access the content of rando, because the method was outside the scope of the while loop, rando variable could not be accessed.    
